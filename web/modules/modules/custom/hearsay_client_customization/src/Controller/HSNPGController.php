...
/**
 * Class Hearsay NPG Controller.
 */

class HSNPGController extends ControllerBase
{
    /**
     * get NPG Controller Theme IDs
    ...
    /**
     * Get Profile Data for NPG Theme
     ...
     */
    public function getProfileDataForNPG($profileData, $moduleName)
    {
        $moduleData = [];
        ...
        switch ($moduleName) {
            ...
            case HS_STRONG_AND_STABLE:
                $moduleData = $this->getStrongStableData($profileData, $config);
                break;
                // Office Info
    ...
    public function getHeroBannerData($profileData, $config)
    {
        ...
        if ($nodeType == 'home') {
            ...
            $defaultBannerDetails = $this->hearsayCommon->getCanonicalMediaDetailsByTheme($defaultBanner, 'field_banner_canonical_name', HS_NPG_AB);
            ...
            if ($profileData->marketing_hero) {
                if ($profileData->marketing_hero->marketing_hero_image) { // If Default Override image is provided
                    ...
                    if ($profileData->marketing_hero->default_marketing_hero_image) { // If Default image selected form dropdown
                        $bannerDetails = $this->hearsayCommon->getCanonicalMediaDetailsByTheme($profileData->marketing_hero->default_marketing_hero_image[0], 'field_banner_canonical_name', HS_NPG_AB);
            ...
            $defaultTeamBannerDetails = $this->hearsayCommon->getCanonicalMediaDetails($defaultTeamBanner, 'field_image_canonical_name', HS_NPG_AB);
    ...
    /**
     * Get Our Story Data for NPG Theme all nodes
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Our Team Data for NPG Theme all nodes
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Our Stroy Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    public function getHomeOurStoryData($profileData, $config)
    {
        ...
        $moduleData = [
            ...
            'our_story_layout' => $profileData->homepage_layouts ? ($profileData->homepage_layouts->our_story_layout_options[0] ? $profileData->homepage_layouts->our_story_layout_options[0] : $config->get('our_story_layout')) : $config->get('our_story_layout'),
    ...
    /**
     * Get Our Stroy Data for NPG Theme About page
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Our Stroy Data for NPG Theme Our Story page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Our Team Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    public function getHomeOurTeamData($profileData, $config)
    {
        ...
        foreach ($profileData->team_members as $teamMember) {
            if (isset($teamMember->show_on_front_page) && $teamMember->show_on_front_page == 'true') {
                $teamDetails[] = [
    ...
    /**
     * Get Our Team Data for NPG Theme About page
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Our Team Data for NPG Theme Our Team page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    public function getMainOfficeDetails($profileData, $config)
    {
        ...
        $officeImage = $profileData->office_photo != '' ? $profileData->office_photo : '';
    ...
    public function getSubOfficeDetails($profileData)
    {
        ...
        if ($subOffices) {
            foreach ($subOffices as $office) {
                ...
                $officeImage = isset($office->image) ? $office->image : '';
                $officeHours = $office->office_hours != '' ? $office->office_hours : '';
                $address = [
                    'street' => isset($office->street) ? $office->street : '',
                    'suite' => isset($office->suite)  ? $office->suite : '',
                    'city' => isset($office->city)  ? $office->city : '',
                    'state' => isset($office->state)  ? $office->state : '',
                    'zip_code' => isset($office->zip_code)  ? $office->zip_code : '',
                ];
                $mapAddress = $office->street . '+' . (isset($office->suite) ? $office->suite : null) . '+' . $office->city . '+' . $office->state . '+' . $office->zip_code;
    ...
    /**
     * Get How We Work With You Data for NPG Theme all nodes
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get How We Work With You Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    public function getHomeWorkWithYouData($profileData, $config)
    {
        ...
        $moduleData = [
            'theme' => HS_NPG_AB,
            'node_type' => HS_HOME,
            'work_with_you_home_page' => isset($profileData->homepage_layouts) ? (isset($profileData->homepage_layouts->how_we_work_hp[0]) ? $profileData->homepage_layouts->how_we_work_hp[0] : TRUE) : TRUE,
            'work_with_you_layout' => isset($profileData->homepage_layouts) ? (isset($profileData->homepage_layouts->how_we_work_layout_options[0]) ? $profileData->homepage_layouts->how_we_work_layout_options[0] : $config->get('work_with_you_layout')) : $config->get('work_with_you_layout'),
            ...
            'video' => isset($profileData->custom_data_2->thumbnail_video) ? KALTURA_LINK_1 . $profileData->custom_data_2->thumbnail_video . KALTURA_LINK_2 : '',
    ...
    /**
     * Get How We Work With You Data for NPG Theme About page
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get How We Work With You Data for NPG Theme How We Work With You page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    public function getDetailWorkWithYouData($profileData, $config)
    {
        ...
        $moduleData = [
            ...
            'video' => isset($profileData->custom_data_2->page_video) ? KALTURA_LINK_1 . $profileData->custom_data_2->page_video . KALTURA_LINK_2 : '',
    ...
    /**
     * Get About Thrivent Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get About Thrivent Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get About Thrivent Data for NPG Theme About page
    ...
    /**
     * Get About Thrivent Data for NPG Theme About Thrivent page
     * @param array Array of settings form data
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Community Impact Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param object Settings form object
     * @return array Array of data to be populated inside module
     */
    ...
    public function getCommunityImpacts($profileData)
    {
        ...
        foreach ($profileData->community_involvements as $communityImpact) {
            ...
            $communityInvolvements[] = [
                ...
                'video' => isset($communityImpact->video) ? KALTURA_LINK_1 . $communityImpact->video . KALTURA_LINK_2 : '',
            ];
        }
    ...
    /**
     * Get Community Impact Data for NPG Theme on Home Page
     * @param array Profile Data received form API Response
     * @param object Settings form object
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Community Impact Data for NPG Theme on About Page
     * @param array Profile Data received form API Response
     * @param object Settings form object
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Community Impact Data for NPG Theme on Listing Page
     * @param array Profile Data received form API Response
     * @param object Settings form object
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Community Impact Data for NPG Theme on Details Page
     * @param array Profile Data received form API Response
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Strong and Stable Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    public function getStrongStableData($profileData, $config)
    {
        $moduleData = [];
        $node_type = $this->hearsayCommon->getThemeIdByNode()['node_type'];
        switch ($node_type) {
                // Home
            case HS_HOME:
                $moduleData = $this->getHomeStrongStableData($profileData, $config);
                break;
                // About Us
            case HS_ABOUT:
                $moduleData = $this->getAboutPgStrongStableData($config);
                break;
                // Strong and Stable
            case HS_STRONG_AND_STABLE:
                $moduleData = $this->getDetailStrongStableData($config);
                break;
            default:
                $moduleData = '';
        }
     ...
     * @return array Array of data to be populated inside module
     */
    public function getHomeStrongStableData($profileData, $config)
    {
        $moduleData = [];
        $thumbnailImgMedia = $thumbnailImgName = $thumbnailImgUrl = $thumbnailVideoName = $thumbnailVideoUrl = $thumbnailVideoMedia = '';
        // Get Thumbnail Image URL
        $thumbnailImgName = $config->get('strong_stable_homepage_thumbnail') != '' ? $config->get('strong_stable_homepage_thumbnail') : '';
        $thumbnailImgDetails = $this->hearsayCommon->getCanonicalMediaDetails($thumbnailImgName, 'field_image_canonical_name');
        $thumbnailImgMedia = reset($thumbnailImgDetails);
        $thumbnailImgUrl = $this->hearsayCommon->getMediaImageUrl($thumbnailImgMedia->field_media_image->target_id); // Get media image URL

        // Get Thumbnail Video URL
        $thumbnailVideoName = $config->get('strong_stable_homepage_video') != '' ? $config->get('strong_stable_homepage_video') : '';
        $thumbnailVideoDetails = $this->hearsayCommon->getCanonicalMediaDetails($thumbnailVideoName, 'field_video_canonical_name');
        $thumbnailVideoMedia = reset($thumbnailVideoDetails);
        ...
        $moduleData = [
            'theme' => HS_NPG_AB,
            'node_type' => HS_HOME,
            'strong_stable_home_page' => $profileData->homepage_layouts ? ($profileData->homepage_layouts->strong_stable_hp[0] ? $profileData->homepage_layouts->strong_stable_hp[0] : 'yes') : 'yes',
            'strong_stable_layout' => isset($profileData->homepage_layouts) ? (isset($profileData->homepage_layouts->strong_stable_layout_options[0]) ? $profileData->homepage_layouts->strong_stable_layout_options[0] : $config->get('strong_stable_layout')) : $config->get('strong_stable_layout'),
            'title' => $config->get('strong_stable_homepage_title') ?? NULL,
            'sub_headline' => $config->get('strong_stable_homepage_subheadline') ?? NULL,
            'short_copy' => $config->get('strong_stable_homepage_short_copy')['value'] ?? NULL,
            'thumbnail_image' => $thumbnailImgUrl ?? NULL,
            'video' => $thumbnailVideoUrl != '' ? $thumbnailVideoUrl : $config->get('strong_stable_homepage_video_link'),
            'media_alt' => $config->get('strong_stable_homepage_alt') ?? NULL,
            'details_page_link' => $this->hearsayCommon->getNodeLinkForCurrentSlug(HS_STRONG_AND_STABLE)['link'],
            'link_text' => $config->get('strong_stable_homepage_link_text') ?? NULL,
            // Condition for hiding Learn more button depending on internal page description
            'is_detail_available' => $config->get('strong_stable_detailpage_short_copy') ? ($config->get('strong_stable_detailpage_short_copy')['value'] != NULL ? true : false) : false,
        ];
        return $moduleData;
    }

    /**
     * Get Strong and Stable Data for NPG Theme About page
     * @param array Array of settings form data
     * @return array Array of data to be populated inside module
     */
    public function getAboutPgStrongStableData($config)
    {
        $moduleData = [];
        $moduleData = [
            'theme' => HS_NPG_AB,
            'node_type' => HS_ABOUT,
            'title' => $config->get('strong_stable_about_title') ?? NULL,
            'description' => $config->get('strong_stable_about_desc') ?? NULL,
            'link' => $this->hearsayCommon->getNodeLinkForCurrentSlug(HS_STRONG_AND_STABLE)['link'],
            'link_text' => $config->get('strong_stable_about_link_text') ?? NULL,
            'short_copy' => $config->get('strong_stable_detailpage_short_copy') ? ($config->get('strong_stable_detailpage_short_copy')['value'] != NULL ? true : false) : false,
        ];
        return $moduleData;
    }
     ...
     * @return array Array of data to be populated inside module
     */
    public function getDetailStrongStableData($config)
    {
        $moduleData = [];
        $pageImgMedia = $pageImgName = $pageImgUrl = $pageVideoName = $pageVideoUrl = $pageVideoMedia = '';
        // Get Thumbnail Image URL
        $pageImgName = $config->get('strong_stable_detailpage_thumbnail') != '' ? $config->get('strong_stable_detailpage_thumbnail') : '';
        $pageImgDetails = $this->hearsayCommon->getCanonicalMediaDetails($pageImgName, 'field_image_canonical_name');
        $pageImgMedia = reset($pageImgDetails);
        $pageImgUrl = $this->hearsayCommon->getMediaImageUrl($pageImgMedia->field_media_image->target_id); // Get media image URL

        // Get Thumbnail Video URL
        $pageVideoName = $config->get('strong_stable_detailpage_video') != '' ? $config->get('strong_stable_detailpage_video') : '';
        $pageVideoDetails = $this->hearsayCommon->getCanonicalMediaDetails($pageVideoName, 'field_video_canonical_name');
        $pageVideoMedia = reset($pageVideoDetails);
        $pageVideoUrl = $pageVideoMedia ? $this->hearsayCommon->getMediaImageUrl($pageVideoMedia->field_media_video_file->target_id) : null; // Get media video URL
        ...
        $moduleData = [
            'theme' => HS_NPG_AB,
            'node_type' => HS_STRONG_AND_STABLE,
            'page_title' => $config->get('strong_stable_page_title') ?? NULL,
            'title' => $config->get('strong_stable_detailpage_title') ?? NULL,
            'sub_headline' => $config->get('strong_stable_detailpage_subheadline') ?? NULL,
            'short_copy' => $config->get('strong_stable_detailpage_short_copy')['value'] ?? NULL,
            'page_image' => $pageImgUrl ?? NULL,
            'video' => $pageVideoUrl != '' ? $pageVideoUrl : $config->get('strong_stable_detailpage_video_link'),
            'media_alt' => $config->get('strong_stable_detailpage_alt') ?? NULL,
            'disclaimer' => $config->get('strong_stable_disclaimer_text')['value'] ?? NULL,
        ];
        return $moduleData;
    }

    /**
     * Get Thrivent Membership Benefits Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Thrivent Membership Benefits Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Thrivent Membership Benefits Data for NPG Theme About page
     * @param array Array of settings form data
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Thrivent Membership Benefits Data for NPG Theme Thrivent Membership Benefits page
     * @param array Array of settings form data
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Products Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    public function getProducts($profileData, $config)
    {
        ...
        if (is_array($additionalProducts) || is_object($additionalProducts)) {
        ...
        foreach ($allAdminProducts as $productName) {
            $media_elements = \Drupal::entityQuery('media')->condition('bundle', 'npg_p3_solutions')->condition('field_solution_canonical_name', $productName)->condition('field_select_category', 'npg')->execute();
            $canonicalDetails = Media::loadMultiple($media_elements);
            $canonicalName = reset($canonicalDetails);
            $canonicalUrl = $canonicalName ? $this->hearsayCommon->getMediaImageUrl($canonicalName->field_media_image->target_id) : null;
            $videoUrl = $canonicalName ? $this->hearsayCommon->getMediaImageUrl($canonicalName->field_solution_video->target_id) : null;
    ...
    /**
     * Get Products Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Products Internal Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Products Data for NPG Theme on Details Page
     * @param array Profile Data received form API Response
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Short Bio Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param object Settings form object
     * @return array Array of theme and Office data to be populated inside module
     */
    ...
    /* Get Additional Information Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get News and Insights Data for NPG Theme
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /**
     * Get Additional Information Data for NPG Theme Home page
     * @param array Profile Data received form API Response
     * @param string Module name constant from settings form
     * @return array Array of data to be populated inside module
     */
    ...
    /* Get Insights Data for NPG Theme
     * @param array Profile Data received form API Response
    ...
    /**
     * Get Additional Information Data for NPG Theme Resources page
     * @param array Array of settings form data
     * @return array Array of data to be populated inside module
     */
    ...
    /* Get News and Insights Data for NPG Theme About page
     * @param array Array of settings form data
     * @return array Array of data to be populated inside module
     */
    ...
    public function getHomeEventsData($profileData, $config)
    {
        ...
        $moduleData = [
            'theme' => HS_NPG_AB,
            'node_type' => $nodeType ?? NULL,
            'events_home_page' => $profileData->homepage_layouts ? ($profileData->homepage_layouts->events_hp[0] ? $profileData->homepage_layouts->events_hp[0] : 'yes') : 'yes',
    ...
    public function getDetailsEventsData($config)
    {
        ...
        $moduleData['theme'] = HS_NPG_AB;
        $moduleData['node_type'] = $nodeType ?? NULL;
        return $moduleData;
    }

    /*
     * Get Footer section for NPG Theme
     * @param array Profile Data received form API Response
     * @param object Settings form object
