...
/**
 * @file
 * Contains Drupal\hearsay_content_configurations\Form\HsLibraryTeamSettings.
 */
...
/**
 * Class HsLibraryTeamSettings.
 *
 * @package Drupal\hearsay_content_configurations\Form
 */
class HsLibraryTeamSettings extends ConfigFormBase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            'hearsay_admin_settings_library_team.settings',
        ];
    }
    ...
    {
        return 'hearsay_admin_settings_library_team_form';
    }
    ...
    {
        $config = $this->config('hearsay_admin_settings_library_team.settings');
        ...
        $solutionMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_SOLUTIONS, HS_LIBRARY_TEAM_AB);
        $heroBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_HOME, HS_LIBRARY_TEAM_AB);
        ...
        if ($heroBannerMediaDetails) {
            foreach ($heroBannerMediaDetails as $heroBannerDetails) {
                $getTargetId = $heroBannerDetails->field_media_image->target_id;
                $heroBannerImages[$heroBannerDetails->field_banner_canonical_name->value] = $this->t($heroBannerDetails->getName());
            }
        }
        ...
        // Get Dropdown details for Team Image
        ...
        $form['home_page_elements']['privacy_policy']['privacy_policy_text'] = [
            ...
            '#default_value' => $config->get('privacy_policy_text')['value'] != NULL ? $config->get('privacy_policy_text')['value'] : '',
            '#format' => 'basic_html',
            '#base_type' => 'textarea',
