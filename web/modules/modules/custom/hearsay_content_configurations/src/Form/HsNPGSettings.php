...
/**
 * @file
 * Contains Drupal\hearsay_content_configurations\Form\HsNPGSettings.
 */
 ...
 */
class HsNPGSettings extends ConfigFormBase
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            'hearsay_admin_settings_npg.settings',
        ];
    }
    ...
    {
        return 'hearsay_admin_settings_npg_form';
    }
    ...
    {
        $config = $this->config('hearsay_admin_settings_npg.settings');
        $hearsayCommon = new HearsayCommon();
        $logoMediaDetails = $siteLogos = [];
        $heroBannerMediaDetails = $heroBannerImages = $aboutBannerMediaDetails = $aboutBannerImages = $solutionsBannerMediaDetails = $solutionsBannerImages = $eventsBannerMediaDetails = $eventsBannerImages = $newsInsightsBannerMediaDetails = $newsInsightsBannerImages = $resourceBannerMediaDetails = $resourceBannerImages = $locationBannerMediaDetails = $locationBannerImages = [];
        $defaultAboutThriventImages = $defaultAboutThriventVideos = $defaultTeamBannerImages = $defaultTeamMemberImages = $aboutDefaultImage = $aboutDefaultVideo = $strongStableDefaultImage = $strongStableDefaultVideo = $teamBannerDefaultImage = $teamMemberDefaultImage = [];
        $logoMediaDetails = $hearsayCommon->getMediaDetails('site_logo');
        $heroBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_HOME, HS_NPG_AB);
        $aboutBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_ABOUT, HS_NPG_AB);
        $solutionsBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_SOLUTIONS, HS_NPG_AB);
        $eventsBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_EVENTS, HS_NPG_AB);
        $newsInsightsBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_NEWS_INSIGHTS, HS_NPG_AB);
        $resourceBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_RESOURCES, HS_NPG_AB);
        $locationBannerMediaDetails = $hearsayCommon->getMediaByNodeAndTheme('banner', HS_LOCATION, HS_NPG_AB);
        ...
        $defaultStrongStableImages = $hearsayCommon->getMediaDetailsByCategory('default_images', 'field_image_category', HS_STRONG_AND_STABLE);
        $defaultStrongStableVideos = $hearsayCommon->getMediaDetailsByCategory('default_videos', 'field_video_category', HS_STRONG_AND_STABLE);
        ...
        $strongStableDefaultImage = $hearsayCommon->getDefaultImageDropdownDetails($defaultStrongStableImages);
        $strongStableDefaultVideo = $hearsayCommon->getDefaultVideoDropdownDetails($defaultStrongStableVideos);
        ...
        $form['strong_stable_elements'] = [
            '#type' => 'details',
            '#title' => $this->t('Strong and Stable Page'),
            '#open' => true,
            '#group' => 'hs_thrivent_config',
        ];
        ...
        // Home Page Strong and Stable - Start

            $form['home_page_elements']['strong_stable_home'] = [
                '#type' => 'details',
                '#title' => $this->t('Strong and Stable Module'),
                '#open' => false,
            ];

            $form['home_page_elements']['strong_stable_home']['strong_stable_layout'] = [
                '#type' => 'select',
                '#title' => $this->t('Default Homepage Layout'),
                '#default_value' => $config->get('strong_stable_layout'),
                '#options' => HOMEPAGE_LAYOUTS
            ];

            $form['home_page_elements']['strong_stable_home']['strong_stable_homepage_link_text'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Link Text'),
                '#default_value' => $config->get('strong_stable_homepage_link_text'),
                '#placeholder' => 'Enter the Link Text to Details Page.'
            ];

        // Home Page Strong and Stable - End
        ...
        // About Page Strong and Stable - Start

            $form['about_us_elements']['strong_stable_about'] = [
                '#type' => 'details',
                '#title' => $this->t('Strong and Stable Module'),
                '#open' => false,
            ];

            $form['about_us_elements']['strong_stable_about']['strong_stable_about_title'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Title'),
                '#default_value' => $config->get('strong_stable_about_title'),
                '#placeholder' => 'Enter the Module title.'
            ];

            $form['about_us_elements']['strong_stable_about']['strong_stable_about_desc'] = [
                '#type' => 'textarea',
                '#title' => $this->t('Description'),
                '#default_value' => $config->get('strong_stable_about_desc'),
                '#placeholder' => 'Enter the Module Description.'
            ];

            $form['about_us_elements']['strong_stable_about']['strong_stable_about_link_text'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Link Text'),
                '#default_value' => $config->get('strong_stable_about_link_text'),
                '#placeholder' => 'Enter the Link Text to Details Page.'
            ];

        // About Page Strong and Stable - End
        ...
        // Strong and Stable Homepage Details - Start

            $form['strong_stable_elements']['strong_stable_homepage'] = [
                '#type' => 'details',
                '#title' => $this->t('Home Page Component'),
                '#open' => false,
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_title'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Title for Homepage component'),
                '#default_value' => $config->get('strong_stable_homepage_title'),
                '#placeholder' => 'Enter the Title for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_subheadline'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Subheadline for Homepage component'),
                '#default_value' => $config->get('strong_stable_homepage_subheadline'),
                '#placeholder' => 'Enter the Subheadline for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_short_copy'] = [
                '#type' => 'text_format',
                '#title' => 'Short copy for Homepage component',
                '#default_value' => isset($config->get('strong_stable_homepage_short_copy')['value']) ? $config->get('strong_stable_homepage_short_copy')['value'] : '',
                '#format' => 'basic_html',
                '#base_type' => 'textarea',
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_thumbnail'] = [
                '#type' => 'select',
                '#title' => $this->t('Thumbnail Image for Homepage component'),
                '#empty_option' => $this->t('--Select--'),
                '#options' => $strongStableDefaultImage,
                '#default_value' => $config->get('strong_stable_homepage_thumbnail'),
                '#description' => $this->t('Select Thumbnail Image for Homepage components.')
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_video'] = [
                '#type' => 'select',
                '#title' => $this->t('Video for Homepage component'),
                '#empty_option' => $this->t('--Select--'),
                '#options' => $strongStableDefaultVideo,
                '#default_value' => $config->get('strong_stable_homepage_video'),
                '#description' => $this->t('Select Video for Homepage components.')
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_video_link'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Video Link for Homepage component'),
                '#default_value' => $config->get('strong_stable_homepage_video_link'),
                '#placeholder' => 'Enter the Video Link for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_homepage']['strong_stable_homepage_alt'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Media ALT Text for Homepage component'),
                '#default_value' => $config->get('strong_stable_homepage_alt'),
                '#placeholder' => 'Enter the Media ALT Text for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage'] = [
                '#type' => 'details',
                '#title' => $this->t('Detail Page Component'),
                '#open' => false,
            ];

        // Strong and Stable Homepage Details - End
        
        // Strong and Stable Page Meta Data - Start

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable'] = [
                '#type' => 'details',
                '#title' => $this->t('Meta Data'),
                '#open' => false,
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['meta_title_des'] = [
                '#type' => 'details',
                '#title' => $this->t('Meta Title and Description'),
                '#open' => false,
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['meta_title_des']['meta_title1_strong_and_stable'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Meta Title 1 for Strong and Stable Page.'),
                '#default_value' => $config->get('meta_title1_strong_and_stable'),
                '#placeholder' => 'Enter the Meta Title (Before First Name and Last Name) for Strong and Stable Page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['meta_title_des']['meta_title2_strong_and_stable'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Meta Title 2 for Strong and Stable Page.'),
                '#default_value' => $config->get('meta_title2_strong_and_stable'),
                '#placeholder' => 'Enter the Meta Title (Between First Name, Last Name and City, State) for Strong and Stable Page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['meta_title_des']['meta_title3_strong_and_stable'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Meta Title 3 for Strong and Stable Page.'),
                '#default_value' => $config->get('meta_title3_strong_and_stable'),
                '#placeholder' => 'Enter the Meta Title (After City and State) for Strong and Stable Page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['meta_title_des']['meta_description_strong_and_stable'] = [
                '#type' => 'textarea',
                '#title' => $this->t('Meta Description for Strong and Stable Page.'),
                '#default_value' => $config->get('meta_description_strong_and_stable'),
                '#placeholder' => 'Enter the Meta Description for Strong and Stable Page.',
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['og_details'] = [
                '#type' => 'details',
                '#title' => $this->t('Open Graph Details'),
                '#open' => false,
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['og_details']['og_description_strong_and_stable'] = [
                '#type' => 'textarea',
                '#title' => $this->t('OG Description for Strong and Stable Page.'),
                '#default_value' => $config->get('og_description_strong_and_stable'),
                '#placeholder' => 'Enter the OG Description for Strong and Stable Page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['og_details']['og_type_strong_and_stable'] = [
                '#type' => 'textfield',
                '#title' => $this->t('OG Type for Strong and Stable Page.'),
                '#default_value' => $config->get('og_type_strong_and_stable'),
                '#placeholder' => 'Enter the OG Type for Strong and Stable Page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['twitter_details'] = [
                '#type' => 'details',
                '#title' => $this->t('Twitter Details'),
                '#open' => false,
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['twitter_details']['twitter_description_strong_and_stable'] = [
                '#type' => 'textarea',
                '#title' => $this->t('Twitter Description for Strong and Stable Page.'),
                '#default_value' => $config->get('twitter_description_strong_and_stable'),
                '#placeholder' => 'Enter the Twitter Description for Strong and Stable Page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['meta_data_strong_and_stable']['twitter_details']['twitter_card_strong_and_stable'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Twitter Card for Strong and Stable Page.'),
                '#default_value' => $config->get('twitter_card_strong_and_stable'),
                '#placeholder' => 'Enter the Twitter Card for Strong and Stable Page.'
            ];

        // Strong and Stable Page Meta Data - End

        // Strong and Stable DetailsPage Details - Start

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data'] = [
                '#type' => 'details',
                '#title' => $this->t('Page Details'),
                '#open' => false,
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_and_stable_page_title'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Page Title for Banner'),
                '#default_value' => $config->get('strong_and_stable_page_title'),
                '#placeholder' => 'Enter the Title for page.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_title'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Title for Detail Page component'),
                '#default_value' => $config->get('strong_stable_detailpage_title'),
                '#placeholder' => 'Enter the Title for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_subheadline'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Subheadline for Detail Page component'),
                '#default_value' => $config->get('strong_stable_detailpage_subheadline'),
                '#placeholder' => 'Enter the Subheadline for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_short_copy'] = [
                '#type' => 'text_format',
                '#title' => 'Short copy for Detail Page component',
                '#default_value' => isset($config->get('strong_stable_detailpage_short_copy')['value']) ? $config->get('strong_stable_detailpage_short_copy')['value'] : '',
                '#format' => 'basic_html',
                '#base_type' => 'textarea',
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_thumbnail'] = [
                '#type' => 'select',
                '#title' => $this->t('Thumbnail Image for Detail Page component'),
                '#empty_option' => $this->t('--Select--'),
                '#options' => $strongStableDefaultImage,
                '#default_value' => $config->get('strong_stable_detailpage_thumbnail'),
                '#description' => $this->t('Select Thumbnail Image for Detail Page components.')
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_video'] = [
                '#type' => 'select',
                '#title' => $this->t('Video for Detail Page component'),
                '#empty_option' => $this->t('--Select--'),
                '#options' => $strongStableDefaultVideo,
                '#default_value' => $config->get('strong_stable_detailpage_video'),
                '#description' => $this->t('Select Video for Detail Page components.')
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_video_link'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Video Link for Detail Page component'),
                '#default_value' => $config->get('strong_stable_detailpage_video_link'),
                '#placeholder' => 'Enter the Video Link for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_detailpage_alt'] = [
                '#type' => 'textfield',
                '#title' => $this->t('Media ALT Text for Detail Page component'),
                '#default_value' => $config->get('strong_stable_detailpage_alt'),
                '#placeholder' => 'Enter the Media ALT Text for Home Page Component.'
            ];

            $form['strong_stable_elements']['strong_stable_detailpage']['strong_stable_detailpage_page_data']['strong_stable_disclaimer_text'] = [
                '#type' => 'text_format',
                '#title' => $this->t('Disclaimer'),
                '#default_value' => isset($config->get('strong_stable_disclaimer_text')['value']) ? $config->get('strong_stable_disclaimer_text')['value'] : '',
                '#format' => 'basic_html',
                '#base_type' => 'textarea',
            ];

        // Strong and Stable Details - End
