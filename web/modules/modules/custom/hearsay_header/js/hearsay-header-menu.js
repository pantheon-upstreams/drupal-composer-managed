/**
 * @file
 * Contains hearsay-header-menu.js.
 */
(function($, Drupal, drupalSettings) {
    ...
    $(document).ready(function() {
        ...
        if (drupalSettings.stayOpen === true) {
            $('.hearsay-header-menu ul.menu').has('.menu-item--active').show();
        }
        ...
        if (drupalSettings.interactiveParentMenu === false) {
            $('.hearsay-header-menu .menu-item--expanded > a').on('click', function(e) {
                e.preventDefault();
            ...
            $('.hearsay-header-menu .menu-item--expanded > .parent-toggle').on('click', function(e) {
                e.preventDefault();
