...
namespace Drupal\Tests\hearsay_header\FunctionalJavascript;
...
/**
 * Tests the Hearsay Header Menu basic config options.
 *
 * @group hearsay_header_menu
 */
class HearsayHeaderMenuBasicTest extends WebDriverTestBase
{
    ...
    /**
     * The placed Hearsay Header Menu block.
     *
    ...
    public function testDynamicBlockTitleDisabled()
    {
        ...
        $this->drupalGet('taxonomy/term/1');
        $block_title_element = $this->getSession()->getPage()->find('css', '#block-hearsayheadermenu h2');
        $this->assertEqual($block_title_element->getText(), 'Hearsay Header Menu');
    }
    ...
    public function testCollapsedAndSelectable()
    {
        ...
        $toggle_elements = $this->getSession()->getPage()->findAll('css', '#block-hearsayheadermenu i.arrow-right.parent-toggle');
    ...
    public function testEmptyBlock()
    {
        ...
        $this->drupalGet('<front>');
        $this->assertSession()->pageTextContains('Hearsay Header Menu');
        ...
        // checked.
        $this->drupalGet('<front>');
        $this->assertSession()->pageTextNotContains('Hearsay Header Menu');
    }
