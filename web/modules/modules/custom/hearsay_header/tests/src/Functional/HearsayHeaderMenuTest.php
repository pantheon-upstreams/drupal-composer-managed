...
/**
 * Tests the Hearsay Header Menu.
 *
 * @group hearsay_header_menu
 */
class HearsayHeaderMenuTest extends BrowserTestBase
{
    ...
    public function testBlockAvailability()
    {
        ...
        $this->assertSession()->linkByHrefExists('admin/structure/block/add/hearsay_header_menu/', 0);
    }
    ...
    public function testBlockConfigForm()
    {
        ...
        $this->drupalGet('admin/structure/block/manage/hearsayheadermenu');
