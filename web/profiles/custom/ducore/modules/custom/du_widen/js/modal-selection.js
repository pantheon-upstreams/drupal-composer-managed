/**
 * @file modal-selection.js
 *
 * Propagates selected entities from modal display. Copied from
...
(function (drupalSettings) {
  ...
  // via ajax commands.
  parent.jQuery(parent.document).find('.entity-browser-du-modal-iframe').parents('.ui-dialog').eq(0).find('.ui-dialog-titlebar-close').click();
