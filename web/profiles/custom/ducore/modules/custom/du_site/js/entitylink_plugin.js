        ...
        init: function (editor) {
                ...
                exec: function (editor) {
                    ...
                    var saveCallback = function (returnValues) {
                        ...
                        // Update the link properties.
                            ...
                            // If we're not supplying href or name param (at the very least), then it means
                            // we're trying to remove the link.
                            if (returnValues.attributes.href == '' && returnValues.attributes.name == '') {
                                var value = linkElement.$.innerHTML;
                                linkElement.$.outerHTML = value;
                            } else {
            ...
            if (editor.ui.addButton) {
                editor.ui.addButton('EntityLink', {
                    label: Drupal.t('Link'),
                    command: 'entitylink',
                    icon: this.path + '../../../contrib/ckeditor_entity_link/js/plugins/entitylink/link.png'
                });
            }
        }
    });
